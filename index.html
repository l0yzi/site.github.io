...
<body>
    ...
    <main>
        ...
        <div class="stage_three">
            <h1 class="txt_stage_three">RoadMap</h1>
            <div class="top_rec">
                <div class="rec">
            ...
            <div class="stage_four" id="contact">
                ...
                <div class="group_circle">
                    <div class="circle" id="one">
                        <img src="assets/tg.png" alt="" style="width: 125px; height: 125px; flex-shrink: 0;">
                    </div>
                    <div class="circle" id="two">
                        <img src="assets/twitter.png" alt="" style="width: 125px; height: 112.915px; flex-shrink: 0;">
                    </div>
                    <div class="circle" id="three">
                        <img src="assets/message.png" alt="" style="width: 125px; height: 125px; flex-shrink: 0;">
                    </div>
                </div>
            </div>
        </div>
